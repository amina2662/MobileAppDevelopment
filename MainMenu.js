...
import { StyleSheet, Image, TouchableOpacity, View, TextInput, FlatList, Text, ImageBackground } from 'react-native';
...
const BookList = () => {
  ...
  return(
    <View style={{flex:1, backgroundColor: 'darkblue'}}>
      ...
      <View style={{flex:0.3, flexDirection:'row', backgroundColor:'royalblue', borderRadius:10, }}>
      <ImageBackground style={{flex:1}} source={require('./assets/pictures/main.png')}>
    ...
    />
      ...
      <TouchableOpacity
        style={{width:90, height:100, marginBottom:10, backgroundColor:'royalblue', alignItems:'center', justifyContent:'center'}}
        onPress={() => navigation.navigate('LabFinal')}
        >
        ...
        <TouchableOpacity
        style={{width:90, height:100, backgroundColor:'royalblue',alignItems:'center', justifyContent:'center'}}
