...
const BookList = () => {
  ...
  return(
    <View style={{ flex:1, backgroundColor: 'darkblue'}}>
        ...
        <Ionicons onPress = {() => navigation.navigate("DashBoard")} name="arrow-back-circle" size={50} color="white" />
        ...
        <Text style={{marginTop:10, fontWeight: 'bold', fontSize: 40, textAlign:'center', fontWeight: 'bold', color: 'white'}}> {name}</Text>
        </View>
